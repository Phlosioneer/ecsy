...
test("Create and use pairs", t => {
    ...
    let child1Handle = child1.getHandle();
    let child2Handle = child2.getHandle();
    let grandparentHandle = grandparent.getHandle();
...
test("Entities can be added to themselves through pairs", t => {
    ...
    let timeTravellerHandle = timeTraveller.getHandle();
